...
class Half2StepBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.titleText.text = BottomSheetOption.HALF_2STEP.name
        setHeightRatio(
            root = binding.root,
            collapsedRatio = 0.5F,
            expandedRatio = 1F
    ...
    companion object {
        fun newInstance(): Half2StepBottomSheetFragment = Half2StepBottomSheetFragment()
    }
}
